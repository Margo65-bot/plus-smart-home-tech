...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNoDeliveryFoundException(
            NoDeliveryFoundException e, HttpServletRequest request) {
        log.debug("DELIVERY NOT FOUND: {}", e.getMessage());
        ApiError apiError = createApiError(e, HttpStatus.NOT_FOUND, "Delivery not found");
