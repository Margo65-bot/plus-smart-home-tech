...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotFoundException(
        ...
        ApiError apiError = createApiError(e, HttpStatus.NOT_FOUND, "Resource not found");
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(NotEnoughInfoInOrderToCalculateException.class)
    public ResponseEntity<ApiError> handleNotEnoughInfoInOrderToCalculateException(
            NotEnoughInfoInOrderToCalculateException e, HttpServletRequest request) {
        log.debug("NOT ENOUGH INFO FOR CALCULATION: {}", e.getMessage());
        ApiError apiError = createApiError(e, HttpStatus.BAD_REQUEST, "Insufficient information for calculation");
        return new ResponseEntity<>(apiError, HttpStatus.BAD_REQUEST);
    }
